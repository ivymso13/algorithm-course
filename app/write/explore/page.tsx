      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-5 px-4 py-6 sm:px-6">
        ...
        {!round ? (
          ...
          <>
            ...
            {/* 2-Column Responsive Workspace: Left = Ideas & Recommendations, Right = Practice Sandbox */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
              {/* Left Column: Peer Ideas & Recommendation Board */}
              <section className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <h2 className="text-sm sm:text-base font-bold text-slate-900">🗳️ 다른 학생 아이디어 & 추천</h2>
                    {board && (
                  ...
                  <div className="space-y-3">
                    {board.map((entry) => (
                      ...
                      >
                        ...
                        <pre className="whitespace-pre-wrap rounded-xl bg-slate-50 p-3 font-mono text-xs leading-relaxed text-slate-800 max-h-48 overflow-y-auto border border-slate-100">
                          {entry.algorithmText}
                        </pre>
              ...
              <section className="space-y-3 lg:sticky lg:top-4 lg:max-h-[calc(100vh-2rem)] lg:overflow-y-auto">
